    ...
    <v-card flat class="transparent mt-5">
      <v-toolbar flat class="transparent">
        <svg
          ...
          data-prefix="fas"
          data-icon="user"
          class="svg-inline--fa fa-user fa-w-14 rounded-circle pa-1"
          role="img"
    ...
    <v-card flat class="transparent mt-5">
      <v-toolbar flat class="transparent">
        <svg
          ...
          class="svg-inline--fa fa-suitcase-rolling fa-w-12 rounded-circle pa-1"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 384 512"
        >
    ...
    <v-card flat class="transparent mt-8">
      <v-toolbar flat class="transparent">
        <svg
          ...
          class="svg-inline--fa fa-hat-wizard fa-w-16 pa-1 rounded-circle"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <v-row class="mt-4 d-flex flex-column">
        ...
        <v-row class="d-flex justify-space-around">
          <v-progress-circular
            ...
            color="#DD4B25"
          >
            <p style="position: absolute; top: 65px; font-size: 10px">95%</p>
            <svg
              width="40"
              height="40"
              aria-hidden="true"
          ...
          <v-progress-circular
            ...
            color="#116FAD"
          >
            <p style="position: absolute; top: 65px; font-size: 10px">82%</p>
            <svg
              width="40"
              height="40"
              aria-hidden="true"
          ...
          <v-progress-circular
            ...
            color="#EFD81D"
          >
            <p style="position: absolute; top: 65px; font-size: 10px">67%</p>
            <svg
              width="40"
              height="40"
              aria-hidden="true"
        ...
        <v-row class="d-flex justify-space-around mt-10">
          ...
          >
            <p style="position: absolute; top: 65px; font-size: 10px">55%</p>
            <svg
              width="40"
              height="40"
              aria-hidden="true"
          ...
          <v-progress-circular
            ...
            color="#D6002F"
          >
            <p style="position: absolute; top: 65px; font-size: 10px">35%</p>
            <svg
              width="40"
              height="40"
              aria-hidden="true"
      ...
      <v-row class="d-flex justify-space-around mt-15">
        <v-chip class="white--text" style="background-color: #005b80" filter
          >JQuery</v-chip
        >
        <v-chip class="white--text" style="background-color: #005b80" filter
          >Bootstrap</v-chip
